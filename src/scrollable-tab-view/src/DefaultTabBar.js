...
class DefaultTabBar extends React.Component {
  ...
  render() {
    const { containerWidth, tabs, backgroundColor, style, scrollValue, underlineStyle} = this.props;
    const numberOfTabs = tabs.length;

    console.log('underlineStyle',underlineStyle.width)

    const left = underlineStyle.width ? containerWidth / numberOfTabs / 2 - underlineStyle.width / 2
